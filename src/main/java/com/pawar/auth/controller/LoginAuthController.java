package com.pawar.auth.controller;
...
import com.pawar.auth.dto.JwtResponseDto;
import com.pawar.auth.dto.LoginDto;
import com.pawar.auth.dto.UserDto;
import com.pawar.auth.service.UserService;
import com.pawar.auth.utils.JwtUtil;
...
public class LoginAuthController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody LoginDto loginDto) {
		...
		try {
			...
			final UserDto userDto = userService.getUserByuserName(loginDto.getUsername());
